...
METALLIB_API_LINK = "https://hackdoc.github.io/MetallibSupportPkg/manifest.json"
...
class MetallibSupportPkgManifest:
    ...
    def _generate_item_manifest(self) -> dict:
        ...
        manifest = {
            ...
            "url":       f"https://github.com/hackodc/metal/releases/download/{version}-{self._latest_ipsw['Build']}/MetallibSupportPkg-{version}-{self._latest_ipsw['Build']}.pkg",
        }
